...
namespace StudentManagement.Controllers
{
    public class Courses1Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseId,Name,LectureName")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,Name,LectureName")] Course course)
        {
